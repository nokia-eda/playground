...
## ----------------------------------------------------------------------------|
EDA_CORE_VERSION ?= 26.4.3
EDA_APPS_VERSION ?= 26.4.3
EDABUILDER_VERSION ?= v26.4.3
...
IS_EDA_CORE_LESSTHAN_268X := 0
IS_EDA_APPS_LESSTHAN_268X := 0
...
else ifeq ($(findstring 26.4,$(EDA_CORE_VERSION)),26.4)
IS_EDA_CORE_LESSTHAN_268X := 1
...
else ifeq ($(findstring 26.4,$(EDA_APPS_VERSION)),26.4)
IS_EDA_APPS_LESSTHAN_268X := 1
